...
/**
 * Handle the Operation  of user information
 *
 * @since 2022-06-15
 * <p>
...
public class UserInfoAction {
    ...
    private static final String ZONE_NAME = "UserInfo";
     ...
     * @return
     */
    public UserInfo buildUserInfo(String uid, String phoneNumber, Boolean event1, Boolean event2) {
