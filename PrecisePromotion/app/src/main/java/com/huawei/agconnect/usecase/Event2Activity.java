...
/**
 * Event1Activity to display the details and Method of event2.
 *
 * @since 2022-06-15
 * <p>
 * Copyright (c) HuaWei Technologies Co., Ltd. 2012-2021. All rights reserved.
 */
public class Event2Activity extends AppCompatActivity implements UserInfoAction.UiCallBack{
    ...
    private void openDB(){
        ...
        mHandler.post(() -> {
            ...
            userInfoAction.addCallBacks(Event2Activity.this);
    ...
    private void purchaseC(){
        AlertDialog dialog = new AlertDialog.Builder(Event2Activity.this)
        ...
        HiAnalyticsInstance instance = HiAnalytics.getInstance(Event2Activity.this);
        //User-defined tracing point. Event triggered by successful participation in activity 2
        Bundle bundle = new Bundle();
        bundle.putString("uid", uid);
        bundle.putString("phoneNumber", phoneNumber);
        instance.onEvent("AttendEvent2", bundle);
    }
